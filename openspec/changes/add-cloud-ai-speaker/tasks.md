...
- [ ] Complete and accept the ADR-0004 ESP-IDF dual-core migration gate.
  ...
  - [x] Board-stage 2: user confirmed the tuned ESP-IDF voice build is acceptable after TTS gain, shorter Qwen replies, UTF-8-safe truncation, and Chinese ASR language hints.
