...
lv_color_t BikeMbUi_ColorEco(void) {
  return BikeMbUi_Rgb(35, 214, 107);
}

lv_color_t BikeMbUi_ColorTrail(void) {
  return BikeMbUi_Rgb(243, 181, 63);
}

lv_color_t BikeMbUi_ColorAuto(void) {
  return BikeMbUi_Rgb(35, 140, 255);
}

lv_color_t BikeMbUi_ColorBoost(void) {
  return BikeMbUi_Rgb(240, 78, 62);
}

lv_color_t BikeMbUi_ModeColor(uint8_t mode_index) {
  switch (mode_index) {
    case 0:
      return BikeMbUi_ColorEco();
    case 1:
      return BikeMbUi_ColorTrail();
    case 2:
