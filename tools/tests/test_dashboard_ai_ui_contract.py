...
def test_ai_button_opens_dedicated_ai_page_on_press() -> None:
    ...
    check("ai button init gpio=" in button, "AI button init parameters must be visible in board logs.")
    check("ai button diag raw=" in button, "AI button poll state must be visible in board logs.")
    check("ai button raw pressed" in button, "AI button raw press level must be visible in board logs for GPIO diagnosis.")
    check("ai button raw released" in button, "AI button raw release level must be visible in board logs for GPIO diagnosis.")
    check("ai button pressed" in button, "AI button press must be visible in board logs for release-unlock acceptance.")
    check("ai button released" in button, "AI button release must be visible in board logs for release-unlock acceptance.")
