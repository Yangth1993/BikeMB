param(
  [string]$SourceDir = "src/assets/audio/mode-prompts",
  [string]$WorkDir = "src/build/generated-prompts"
)
...
$HeaderPath = Join-Path $RepoRoot "src/firmware/bikemb/src/audio/audio_prompt_assets.h"
$SourcePath = Join-Path $RepoRoot "src/firmware/bikemb/src/audio/audio_prompt_assets.cpp"
...
[void]$Source.AppendLine("// Generated by tools/generate-mode-prompts.ps1 from src/assets/audio/mode-prompts source files.")
