...
- ADR-0004 ESP-IDF 双核门禁尚未关闭：2026-07-22/23 第一轮已验证启动、双核 task 归属、LVGL 单 owner、资源日志、BOOT 按住上电不误触发、ESP-IDF Wi-Fi STA 上线、4MB app 分区、CST816 初始化和 90 秒以上显示长稳；释放解锁后再触发、真实触摸手势日志、ESP-IDF AudioSession codec/I2S、真实云 transport、录音/TTS/取消回归仍未完成。
